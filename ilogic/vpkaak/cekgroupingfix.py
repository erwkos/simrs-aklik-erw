...
def grouping(gender=str, umur=str, no_sep=str, no_peserta=str, tipe_rawat=str,
    ...
    with transaction.atomic():
        ...
        login_url = 'http://localhost:8080/E-Klaim/login.php'
        ...
        if response.url.startswith('http://localhost:8080/E-Klaim/index.php') and 'success=1' in response.url:
            try:
                ...
                new_patient_url = 'http://localhost:8080/E-Klaim/index.php?X_his=padm&slpat_new_pat=1'
                session.get(new_patient_url)

                add_new_patient_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_savePerson&ffargs[0]=mrn%255E%255E{mrn}%2540%2540person_nm%255E%255E{person_nm}%2540%2540adm_gender_cd%255E%255E{gender}%2540%2540birth_dttm%255E%255E{birth_dttm}%25200%253A0%253A0&ffargs[1]=new&ffargs[2]=&ffrnd={waktusekarang}'
                # add_new_patient_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?/E-Klaim/ajaxreq.php?ac=pt&ff=app_savePerson&ffargs[0]=mrn%255E%255E18325749%2540%2540person_nm%255E%255EBPJS%2520Kesehatan%2540%2540adm_gender_cd%255E%255Em%2540%2540birth_dttm%255E%255E1988-6-17%25200%253A0%253A0&ffargs[1]=new&ffargs[2]=&ffrnd=1718636053065'
                ...
                add_1_klaim_baru = 'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_newAdmission'
                ...
                add_2_klaim_baru = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_editAdmission&ffargs[0]={number}'
                ...
                sending1 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=resume_medis'
                sending2 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=ruang_rawat'
                sending3 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=radiologi'
                sending4 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=resep_obat'
                sending5 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=laboratorium'
                sending6 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=penunjang_lain'
                sending7 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=tagihan'
                sending8 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=kartu_identitas'
                sending9 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=dokumen_kipi'
                sending10 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=bebas_biaya'
                sending11 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=surat_kematian'
                sending12 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_getUploadedFile&ffargs[0]={number}&ffargs[1]=lain_lain'
                sending13 = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_setGrouperTab&ffargs[0]=0'
                ...
                # send2_grouping_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_grouper&ffargs[0]={number}&ffargs[1]=no_kartu%255E%255E{no_peserta}%2540%2540no_sep%255E%255E{no_sep}%2540%2540admission_type%255E%255E{tipe_rawat}%2540%2540tariff_class%255E%255E{kelas_rawat}%2540%2540admission_dttm%255E%255E{sekarang.year}-{sekarang.month:02}-{sekarang.day:02}%2520{sekarang.hour:02}%253A{sekarang.minute:02}%253A{sekarang.second:02}%2540%2540discharge_dttm%255E%255E{sekarang.year}-{sekarang.month:02}-{sekarang.day:02}%2520{sekarang.hour:02}%253A{sekarang.minute:02}%253A{sekarang.second:02}%2540%2540episodes%255E%255E%2540%2540cc_ind%255E%255E0%2540%2540akses_naat%255E%255EC%2540%2540isoman_ind%255E%255E0%2540%2540rs_darurat_ind%255E%255E0%2540%2540co_insidence_ind%255E%255E0%2540%2540cgrp_rs_darurat_ind%255E%255E0%2540%2540cgrp_isoman_ind%255E%255E0%2540%2540upgrade_class_los%255E%255E0%2540%2540ventilator_start_dttm%255E%255E0000-00-00%252000%253A00%253A00%2540%2540ventilator_stop_dttm%255E%255E0000-00-00%252000%253A00%253A00%2540%2540icu_los%255E%255E0%2540%2540birth_weight%255E%255E{birth_weight}%2540%2540adl1%255E%255E12%2540%2540adl2%255E%255E12%2540%2540jkn_sitb_noreg%255E%255E%2540%2540covid19_no_sep%255E%255E%2540%2540billing_amount_pex%255E%255E0%2540%2540billing_amount%255E%255E1000000%2540%2540procedure_amt%255E%255E1%252C000%252C000%2540%2540surgical_amt%255E%255E0%2540%2540consul_amt%255E%255E0%2540
cd%255E%255E1%2540%2540covid19_status_cd%255E%255E4%2540%2540discharge%255E%255Ehome%2540%2540attending_doctor%255E%255E1%257C{dpjp_option}%2540%2540rs_tariff%255E%255E{rs_tarif}%2540%2540sp%255E%255ENone%2540%2540sr%255E%255ENone%2540%2540si%255E%255ENone%2540%2540sd%255E%255ENone%2540%2540anamnesa%255E%255E%2540%2540indikasi_ranap%255E%255E%2540%2540diagnosa_primer%255E%255E%2540%2540diagnosa_sekunder%255E%255E%2540%2540prosedur%255E%255E%2540%2540laporan_operasi%255E%255E'
                send2_grouping_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_grouper&ffargs[0]={number}&ffargs[1]=no_kartu%255E%255E{no_peserta}%2540%2540no_sep%255E%255E{no_sep}%2540%2540admission_type%255E%255E{tipe_rawat}%2540%2540tariff_class%255E%255E{kelas_rawat}%2540%2540admission_dttm%255E%255E{Tglplgsjp.year}-{Tglplgsjp.month:02}-{Tglplgsjp.day:02}%2520{sekarang.hour:02}%253A{sekarang.minute:02}%253A{sekarang.second:02}%2540%2540discharge_dttm%255E%255E{Tglplgsjp.year}-{Tglplgsjp.month:02}-{Tglplgsjp.day:02}%2520{sekarang.hour:02}%253A{sekarang.minute:02}%253A{sekarang.second:02}%2540%2540episodes%255E%255E%2540%2540cc_ind%255E%255E0%2540%2540akses_naat%255E%255EC%2540%2540isoman_ind%255E%255E0%2540%2540rs_darurat_ind%255E%255E0%2540%2540co_insidence_ind%255E%255E0%2540%2540cgrp_rs_darurat_ind%255E%255E0%2540%2540cgrp_isoman_ind%255E%255E0%2540%2540upgrade_class_los%255E%255E0%2540%2540ventilator_start_dttm%255E%255E0000-00-00%252000%253A00%253A00%2540%2540ventilator_stop_dttm%255E%255E0000-00-00%252000%253A00%253A00%2540%2540icu_los%255E%255E0%2540%2540birth_weight%255E%255E{birth_weight}%2540%2540adl1%255E%255E12%2540%2540adl2%255E%255E12%2540%2540jkn_sitb_noreg%255E%255E%2540%2540covid19_no_sep%255E%255E%2540%2540billing_amount_pex%255E%255E0%2540%2540billing_amount%255E%255E1000000%2540%2540procedure_amt%255E%255E1%252C000%252C000%2540%2540surgical_amt%255E%255E0%2540%2540consul_amt%255E%255E0%2540%2540expert_amt%255E%255E0%2540%2540nursing_amt%255E%255E0%2540%2540ancillary_amt%255E%255E0%2540%2540radiology_amt%255E%255E0%2540%2540laboratory_amt%255E%255E0%2540%2540blood_amt%255E%255E0%2540%2540rehab_amt%255E%255E0%2540%2540room_amt%255E%255E0%2540%2540intensive_amt%255E%255E0%2540%2540drug_amt%255E%255E0%2540%2540drug_chronic_amt%255E%255E0%2540%2540drug_chemo_amt%255E%255E0%2540%2540device_amt%255E%255E0%2540%2540consumable_amt%255E%255E0%2540%2540device_rent_amt%255E%255E0%2540%2540terapi_konvalesen%255E%255E0%2540%2540panelitem_1011_3%255E%255E{icd10}%2540%2540panelitem_1012_1%255E%255E{icd9}%2540%2540panelitem_1011_4%255E%255E%2540%2540panelitem_1012_2%255E%255E%2540%2540jkn_sistole%255E%255E0%2540%2540jkn_diastole%255E%255E0%2540%2540jkn_apgar_1_appearance%255E%255E%2540%2540jkn_apgar_1_pulse%255E%255E%2540%2540jkn_apgar_1_grimace%255E%255E%2540%2540jkn_apgar_1_activity%255E%255E%2540%2540jkn_apgar_1_respiration%255E%255E%2540%2540jkn_apgar_5_appearance%255E%255E%2540%2540jkn_apgar_5_pulse%255E%255E%2540%2540jkn_apgar_5_grimace%255E%255E%2540%2540jkn_apgar_5_activity%255E%255E%2540%2540jkn_apgar_5_respiration%255E%255E%2540%2540jkn_usia_kehamilan%255E%255E0%2540%2540jkn_gravida%255E%255E0%2540%2540jkn_partus%255E%255E0%2540%2540jkn_abortus%255E%255E0%2540%2540jkn_onset_kontraksi%255E%255Espontan%2540%2540nomor_rujukan%255E%255E%2540%2540kode_perujuk%255E%255E%2540%2540cara_masuk%255E%255Erujukan_fktp%2540%2540usia_kehamilan%255E%255E0%2540%2540sistole%255E%255E0%2540%2540diastole%255E%255E0%2540%2540gravida%255E%255E0%2540%2540partus%255E%255E0%2540%2540abortus%255E%255E0%2540%2540onset_kontraksi%255E%255Espontan%2540%2540riwayat_sc%255E%255E0%2540%2540kuretase%255E%255E0%2540%2540nama_operasi%255E%255E%2540%2540payplan_id%255E%255E3%2540%2540cob_id%255E%255E-%2540%2540cara_masuk%255E%255Egp%2540%2540bayi_lahir_status_cd%255E%255E1%2540%2540covid19_status_cd%255E%255E4%2540%2540discharge%255E%255Ehome%2540%2540attending_doctor%255E%255E1%257C{dpjp_option}%2540%2540rs_tariff%255E%255E{rs_tarif}%2540%2540sp%255E%255ENone%2540%2540sr%255E%255ENone%2540%2540si%255E%255ENone%2540%2540sd%255E%255ENone%2540%2540anamnesa%255E%255E%2540%2540indikasi_ranap%255E%255E%2540%2540diagnosa_primer%255E%255E%2540%2540diagnosa_sekunder%255E%255E%2540%2540prosedur%255E%255E%2540%2540laporan_operasi%255E%255E'
                send3_grouping_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_grouperSpecial&ffargs[0]={number}&ffargs[1]=1&ffargs[2]=sp%255E%255E{sp}%2540%2540sr%255E%255E{sr}%2540%2540si%255E%255E{si}%2540%2540sd%255E%255E{sd}'
                ...
                if sp == None and sr == None and si == None and sd == None or sp == 'None' and sr == 'None' and si == 'None' and sd == 'None':
                    ...
                    send3_grouping_url = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=pt&ff=app_grouperSpecial&ffargs[0]={number_find}&ffargs[1]=1&ffargs[2]=sp%255E%255E{sp}%2540%2540sr%255E%255E{sr}%2540%2540si%255E%255E{si}%2540%2540sd%255E%255E{sd}'
                    send3_grouping_url_response = session.post(send3_grouping_url)
                ...
                pasien = 'http://localhost:8080/E-Klaim/index.php?X_his=padm&slpat_selectpat=1'
                session.post(pasien)
                hapus_pasien = f'http://localhost:8080/E-Klaim/ajaxreq.php?ac=slpt&ff=app_deletePatient&ffrnd={waktusekarang}'
...
def query_icd10(request):
    ...
    if query:
        ...
        # cookie_value = 'umk96d5gk3s69v6kj49uiratj6'
        ...
        url = 'http://localhost:8080/e-klaim/ajaxreq.php'
        headers = {
            'Host': 'localhost:8080',
            ...
            'Referer': f'http://localhost:8080/E-Klaim/index.php?rand={uuid.uuid4()}',
...
def pindahrs(koders):
    with transaction.atomic():
        ...
        if response.url.startswith('http://localhost:8080/E-Klaim/index.php') and 'success=1' in response.url:
            ...
            pindah_group = 'http://localhost:8080/E-Klaim/index.php?XP_syschpgroup_menu=0'
            session.get(pindah_group)
            setup_rs = 'http://localhost:8080/E-Klaim/index.php?XG_10=rs'
            ...
            session.get(pindah_group)
            administrasi_klaim = 'http://localhost:8080/E-Klaim/index.php?XG_9=klaim'
