...
urlpatterns = [
    ...
    path('api/json/monitoring/dataklaim/pending/dispute/stafak/', views.api_json_data_klaim_pending_dispute_CBG_stafak, name='api_json_data_klaim_pending_dispute_CBG_stafak'),
