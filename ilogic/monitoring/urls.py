...
urlpatterns = [
    ...
    path('api/json/monitoring/dataklaim/cbg/pending/dispute/supervisor', views.api_json_data_klaim_pending_dispute_CBG_supervisor, name='api_json_data_klaim_pending_dispute_CBG_supervisor'),
    ...
    path('api/json/monitoring/dataklaim/obat/pending/dispute/supervisor', views.api_json_data_klaim_pending_dispute_obat_supervisor, name='api_json_data_klaim_pending_dispute_obat_supervisor'),
    ...
    path('dataklaim/CBG/pending/dispute/supervisor', views.monitoring_data_klaim_pending_dispute_CBG_supervisor, name='monitoring_data_klaim_pending_dispute_CBG_supervisor'),
    ...
    path('dataklaim/obat/pending/dispute/supervisor', views.monitoring_data_klaim_pending_dispute_obat_supervisor, name='monitoring_data_klaim_pending_dispute_obat_supervisor'),
